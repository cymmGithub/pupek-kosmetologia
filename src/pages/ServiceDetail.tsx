...
import { ArrowLeft, Clock, Sparkles, CheckCircle2, AlertCircle } from 'lucide-react';
...
const servicesContent: Record<string, ServiceContent> = {
  'konsultacja-kosmetologiczna': {
    ...
    image: 'https://images.pexels.com/photos/6663361/pexels-photo-6663361.jpeg?auto=compress&cs=tinysrgb&w=1920',
    sections: [
      {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-serif mb-4">Usługa nie została znaleziona</h1>
          <Link to="/">
        ...
        <div className="relative h-full container mx-auto px-4 lg:px-8 flex items-end pb-16 md:pb-24">
          <div ref={heroRef} className="max-w-3xl">
            ...
            >
              ...
              <span className="text-sm font-light">Powrót do zabiegów</span>
            </Link>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex items-start gap-4 p-4 rounded-xl bg-secondary/30 transition-colors hover:bg-secondary/50">
                ...
                <div>
                  <p className="text-sm text-foreground/60 mb-1">Czas trwania</p>
              ...
              <div className="flex items-start gap-4 p-4 rounded-xl bg-secondary/30 transition-colors hover:bg-secondary/50">
                ...
                <div>
                  ...
                  {service.priceNote && (
                    <p className="font-bold text-xs text-foreground/50 italic mt-1">{service.priceNote}</p>
                  )}
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {service.importantNote && (
              <div
                ...
                style={{ transitionDelay: `${(service.sections.length + 1) * 150}ms` }}
              >
                <div className="relative border-2 border-primary/30 bg-gradient-to-br from-primary/5 via-primary/3 to-accent/5 rounded-2xl p-8 md:p-10 overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <div className="space-y-4 ml-0 md:ml-16">
                      {service.importantNote.content.map((paragraph, pIndex) => (
                        <p
                          key={pIndex}
