        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              >
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-primary/10 group-hover:bg-primary/20 group-hover:scale-110 transition-all duration-300" style={{ transitionTimingFunction: 'var(--ease-out-quart)' }}>
          ...
          >
            <div className="relative w-full h-[500px] lg:h-[600px] group">
              ...
              {/* Image container */}
              <div className={`relative w-full h-full overflow-hidden rounded-xl shadow-2xl image-reveal ${
                imageVisible ? 'active' : ''
              }`}>
                <img
                  src="/contact.jpg"
