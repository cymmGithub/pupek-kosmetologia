...
const services: Service[] = [
	...
	},
	{
		...
		description:
			"Głębokie nawilżenie i regeneracja skóry dla przywrócenia jej naturalnej równowagi.",
		price: "250-350zł (ok. 1h)",
...
const Services = () => {
	...
	return (
		<section
			id='services'
			className='relative pb-24 md:pb-32 bg-gradient-to-br from-background via-secondary/10 to-background overflow-hidden scroll-mt-32'
		>
			...
			<div className='container mx-auto px-4 lg:px-8 relative z-10'>
				...
				<div ref={titleRef} className='text-center mb-20 md:mb-28'>
					...
					<div className='overflow-hidden'>
						...
						>
							Każdy zabieg jest starannie dobrany, aby odpowiedzieć na aktualne
								...
								<div className='pt-4 border-t border-border/50 group-hover:border-primary/20 transition-colors duration-300'>
									<div className='flex items-start justify-between gap-4'>
										<div className='flex flex-col gap-1'>
											...
											{service.priceNote && (
												<span className='font-bold text-foreground/50 text-xs italic'>
													{service.priceNote}
												</span>
											)}
										</div>
